...
public class MainPanel extends JPanel {
    ...
    private JPanel createSidebar() {
        ...
        if (currentUser.isKasir()) {
            ...
            addMenuButton(panel, "Pesanan Pelanggan", () -> showOrderPanel());
        } else if (currentUser.isOwner()) {
            addMenuButton(panel, "Kelola Produk", () -> showProductPanel());
            addMenuButton(panel, "Kelola Kategori", () -> showCategoryPanel());
            addMenuButton(panel, "Kelola Supplier", () -> showSupplierPanel());
            ...
            addMenuButton(panel, "Pesanan Saya", () -> showOrderPanel());
        }
